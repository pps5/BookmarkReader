package io.github.pps5.bookmarkreader.feature.entries.view
...
// calls onScrollChanged if applicable.
    ...
    ): Boolean { // this is causing double scroll call (doubled speed), but this WebView isn't overscrollable
...
// (webview should move a bit making input still in viewport when "adjustResize")
    ...
    val scrollRange: Int
        get() =//Using scroll range of webview instead of childs as NestedScrollView does.
    ...
    override fun computeScroll() {
        ...
        if (unconsumed != 0) { // Internal Scroll
            val oldScrollY = scrollY
            overScrollByCompat(
                0, unconsumed, scrollX, oldScrollY, 0, scrollRange,
                0, 0, false
            )
